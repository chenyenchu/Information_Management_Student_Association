          ...
          <div class="container grid px-6 mx-auto">
            ...
            <div class="max-w-2xl px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800" id="party">
              ...
              <p class="mb-4 text-sm text-gray-600 dark:text-gray-400"></p>
                ...
                費用：500元/人
                <div>
                  <button class="mt-4 px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border
                   border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                    <a href="forms_2_user.php">前往報名</a>
                  </button>
                </div>
              </p>
            </div>
