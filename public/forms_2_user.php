      ...
      <div class="flex flex-col flex-1 w-full">
        ...
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container px-6 mx-auto grid">
            ...
            <form method="get" action="dblink_signup_user.php">
              ...
              <input type="hidden" name="dbaction" value="insert">
                <label class="block">
                    ...
                    focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="例:小明" name="SName">
                </label>
                ...
                <label class="block mt-4 text-sm">
                  ...
                  <select class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400
                   focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" name="SGrade">
                ...
                <label class="block mt-4 text-sm">
                  <span class="mb-4 text-lg font-semibold text-gray-600 dark:text-gray-300">電話號碼</span>
                  <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 
                    focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" 
                  placeholder="例:0912345678" name="SPhone">
                </label>
                <label class="block mt-4 text-sm">
                  <span class="mb-4 text-lg font-semibold text-gray-600 dark:text-gray-300">緊急聯絡人/電話</span>
                  <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 
                    focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                     placeholder="例:大明/0900000000" name="Contant">
                </label>
                <label class="block mt-4 text-sm">
                  <span class="mb-4 text-lg font-semibold text-gray-600 dark:text-gray-300">
                    活動
                  ...
                  <select class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400
                   focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" name="Activity">
                    <option>耶誕舞會</option>
                    <option>宿營</option>
                    <option>制服趴</option>
                    <option>抽系櫃</option>
                ...
                <label class="block mt-4 text-sm">
                  <span class="mb-4 text-lg font-semibold text-gray-600 dark:text-gray-300">備註</span>
                  <textarea class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-purple-400
                   focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" rows="3" placeholder="例:蛋奶素、疾病" name="Note"></textarea>
                </label>
                <br>
                <div class="mt-3 block w-full text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-purple-400
                 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
                  隱私政策:<br>
                  1.資管系學會向您集之個人資料，僅作為活動收集個人資訊所用、集、處理及使用您的個人資料是受到個人資料保護法及相關法令之規範。<br>
                  2.本次集之個人資料包含得以直接或間接識別個人之相關資訊。期限自取得起日至活動中指日為止，並遵守個人資料保護法及規定妥善保護您的個人資訊。<br>
                  3.您同意資管系學會因活動所需，以您所提供的個人資料與您進行聯繫與通知。<br>
                  4.本同意書如有未盡事宜，依個人資料保護法或其他相關法規之規定辦理。<br>
                </div>
                ...
                <br>
              <div>
                <button @click="openModal" type="submit" id="submitButton" 
                  class="disabled px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent
