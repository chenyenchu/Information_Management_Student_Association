            ...
            <form method="get" action="dblink.php">
                <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    ...
                    <label class="block text-lg">
                        ...
                        focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" name="AName">
                    </label>
                    <label class="block mt-4 text-sm">
                        <span class="mb-4 text-lg font-semibold text-gray-600 dark:text-gray-300">時間</span>
                        <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 
                        focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" name="Time">
                    </label>
                    <label class="block mt-4 text-sm">
                        <span class="mb-4 text-lg font-semibold text-gray-600 dark:text-gray-300">費用</span>
                        <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 
                        focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" name="Money">
                    </label>
                    <label class="block mt-4 text-sm">
                        <span class="mb-4 text-lg font-semibold text-gray-600 dark:text-gray-300">地點</span>
                        <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 
                        focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" name="Place">
                    </label>
                    <label class="block mt-4 text-sm">
                        <span class="mb-4 text-lg font-semibold text-gray-600 dark:text-gray-300">備註</span>
                        <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 
                        focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" name="ANote">
                    </label>
                    <div class="px-6 my-6">
