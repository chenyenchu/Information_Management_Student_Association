    ...
    <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen }">
      ...
      <div class="flex flex-col flex-1 w-full">
        ...
        <?php
          ...
          $sql = "select * from activity where AName='". $AName. "'";
        ...
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container px-6 mx-auto grid">
            ...
            <!-- General elements -->
            <form  method="get" action="dblink.php">
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <label class="block text-lg">
                  <span class="mb-4 text-lg font-semibold text-gray-600 dark:text-gray-300">活動名稱 : </span>
                  <?php echo $AName; ?>
                </label>
                <label class="block mt-4 text-sm">
                  <span class="mb-4 text-lg font-semibold text-gray-600 dark:text-gray-300">時間</span>
                  <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 
                  focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" name="Time" value="<?php echo $Time; ?>">
                </label>
                <label class="block mt-4 text-sm">
                  <span class="mb-4 text-lg font-semibold text-gray-600 dark:text-gray-300">費用</span>
                  <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 
                  focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" name="Money" value="<?php echo $Money; ?>">
                </label>
                <label class="block mt-4 text-sm">
                  <span class="mb-4 text-lg font-semibold text-gray-600 dark:text-gray-300">地點</span>
                  <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 
                  focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" name="Place" value="<?php echo $Place; ?>">
                </label>
                <label class="block mt-4 text-sm">
                  <span class="mb-4 text-lg font-semibold text-gray-600 dark:text-gray-300">備註</span>
                  <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 
                  focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" name="ANote" value="<?php echo $ANote; ?>">
                </label>
                <div class="px-6 my-6">
