      ...
      <div class="flex flex-col flex-1 w-full">
        ...
        <main class="h-full overflow-y-auto">
                  ...
                  <thead>
                    <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400
                     dark:bg-gray-800">
                      ...
                      <th class="px-4 py-3">緊急聯絡人</th>
                      <th class="px-4 py-3">報名活動</th>
                    ...
                    if(isset($searchtxt)){
                        $sql = "select * from signup where Activity like '%". $searchtxt. "%'";
                    }
                    else{
                    ...
                    while($row = mysqli_fetch_assoc($result)){
                        echo "<tr><td>", $row['SName'], "</td><td>", $row['SID'], "</td><td>", $row['SGrade'],"</td><td>", $row['SPhone'], "</td><td>", $row['Contant'],
                         "</td><td>", $row['Activity'], "</td><td>", $row['Note'],"</td><td><br><a href='delete_signup.php?SName=",
                          $row['SName'], "&Activity=", $row['Activity'], "'>刪除</td></tr>";
                    }
                    ?>
                  </thead>
                </table>
          ...
          <form method="post" action="download.php">
            <input type="submit" name="submit" value="下載表單">          
          </form>
        </main>
      </div>
    </div>
